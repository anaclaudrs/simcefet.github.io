...
/**
 * Simulação de colisão unidimensional elástica.
 */
class ColisaoUnidimensionalElastica extends Component {
    ...
    iterar(scene, camera, elapsedTime) {
        ...
        if (this.colidiram && this.calcular) {
            ...
            this.esfera1_velocidadeAtual = 
                ...
                + ((2 * this.state.esfera2_massa) / denominador) * this.state.esfera2_velocidade ;

            this.esfera2_velocidadeAtual = 
...
export default ColisaoUnidimensionalElastica;
